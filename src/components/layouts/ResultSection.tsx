...
export const ResultSection = ({ visible, data }: ResultSectionProps) => {
    ...
    const nodes: Node[] = [
      {
        ...
        style: {
          background:
            data.riskScore && data.riskScore > 70 ? "#fef2f2" : "#f0fdf4",
          border:
            data.riskScore && data.riskScore > 70
              ? "2px solid #ef4444"
              : "2px solid #22c55e",
          borderRadius: "8px",
          padding: "10px",
  ...
  function downloadReport(
    ...
    if (format === "json") {
      ...
      a.href = url;
      a.download = `transaction-analysis-${
        data.hash?.slice(0, 10) || "report"
      }.json`;
      ...
      doc.save(
        `transaction-analysis-${data.hash?.slice(0, 10) || "report"}.pdf`
      );
    }
  }
      ...
      <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        {loading ? (
          <div className="flex items-center justify-center py-12">
            ...
            <span className="ml-4 text-black">Processing analysis...</span>
          </div>
        ) : (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-2 text-sm">
                {data.hash && (
                  <div>
                    ...
                    <span className="ml-2 font-mono text-xs break-all text-black">
                      {data.hash}
                    </span>
                  </div>
                )}
                ...
                <div>
                  ...
                  <span className="ml-2 font-mono text-xs text-black">
                    {data.from}
                  </span>
                </div>
                <div>
                ...
                {data.blockNumber && (
                  <div>
                    ...
                    <span className="ml-2 text-black">{data.blockNumber}</span>
                  </div>
                )}
                {data.gasUsed && (
                  <div>
            ...
            <div className="lg:col-span-2">
              ...
              <div
                className="bg-gray-50  text-black rounded-lg p-4"
                style={{ height: "300px" }}
              >
